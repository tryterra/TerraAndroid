...
`implementation co.tryterra:terra-android:1.3.0`
...
**Warning: This call can throw an `TerraInvalidRequest` error! This happens when your `dev-id` is inactive/has reached user limits! (From 1.2.3 onwards, this is no longer thrown)**
...
- `callback: (Boolean) -> Unit` ➡ A callback function dictating whether the initialisation was successful **RECOMMEND TO WAIT FOR THIS FUNCTION BEFORE PROCEEDING**
